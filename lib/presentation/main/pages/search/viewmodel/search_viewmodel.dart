...
class SearchViewModel extends BaseViewModel with SearchViewModelInput,SearchViewModelOutput { 
  ...
  SearchViewModel(this._mapUseCase);
  ...
  _getMapData() async{  
    ...
    (await _mapUseCase.execute(id)).fold( 
        (failure) => {
              // left -> failure
