...
class RegisterViewModel extends BaseViewModel
  ...
  StreamController isUserRegisteredInSUccessfulyStreamController = StreamController<bool>();
  ...
  void dispose() {
    ...
    isUserRegisteredInSUccessfulyStreamController.close();
    super.dispose();
  }
...
*/
  ...
  register() async {
    ...
    (await _registerUseCase.execute(RegisterUseCaseInput(
      ...
      isUserRegisteredInSUccessfulyStreamController.add(true);
    });
  }
  ...
  //setProfilePicture(File profilePicture) {
    ...
    //  registerObject = registerObject.copyWith(profilePicture: "link");
    //}
    //validate();
  //}
